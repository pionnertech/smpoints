...
<input type="button" id="fullscreen" class="scrollable" />
<input type="number" id="mesa" class="scrollable"/>
...
<div id="highBar" align="center" >
    <a href="#"><img class="scrollable" src="images/entrar.png"></a>
</div>
</div>

<div class="section" id="item2" data-anchor="item2-slide">
<a href="#item1" style="width:4em; position: relative; float: left;"><div class="scrollable" style=" width:4.5em;"><i class="fa fa-chevron-circle-left fa-3x" style="color: white;"></i></div></a>
  <div class="wrap-item2" align="center">
  	    <div class="scrollable"id="to4" style="font-weight: bolder;">Quiero usar mis Smile Points</div>
    </div>
    <div class="wrap-item2" align="center">
  	    <div class="scrollable"id="to3" style="font-weight: bolder;">Quiero registrarme</div>
    </div>
</div>
<div class="section" id="item3" >
<a href="#item2" style="width:4em;" onclick="IR_SWITCH = 0;" class="scrollable" ><div class="scrollable" style="width:4.5em;"><i class="fa fa-chevron-circle-left fa-3x" style="color: white;"></i></div></a>
	   <div class="grand-wrap" align="center">
            <div class="wrap" align="center">
	            <div style="display: inline-block; vertical-align: top;" class="credentials">
	                <input type="text" id="nUs" class="scrollable" placeholder="Ingresa tu nombre y apellido">
            </div>
           </div>
<div class="wrap" align="center">
	<div style="display: inline-block; vertical-align: top;" class="credentials">
	    <input type="text" id="eUs" class="scrollable" placeholder="Ingresa tu E-mail">
	</div> 
...
$(document).bind('touchmove touchstart', function (event) {
...
switch(parseInt(data)) {
  ...
  var variables = data.split(',');
    $("#score-user").html(variables[1]);
      swal({ title : "Bienvenido "  + variables[0], text: "Disfruta de tus puntos!",  type: "success", timer : "5000", confirmButtonColor: "#fff"});
        IR_SWITCH = 0;
